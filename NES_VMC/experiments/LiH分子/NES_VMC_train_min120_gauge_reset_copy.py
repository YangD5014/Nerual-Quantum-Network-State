...
if __name__ == "__main__":
    ...
    log_path = f"./日志/{time_str}_nes_vmc_K4_LiH_STO-3G_min120_gauge_reset.log"
    ...
    HISTORY_FILE = "./data/history_natural_gradient_LiH_molecule_K4.pkl"
    ...
    loss_fig_path = _save_curve(
        ...
        f"./日志/{time_str}_loss_curve_gauge_reset_min120.png",
    )
    ...
    logpsi_fig_path = _save_curve(
        ...
        f"./日志/{time_str}_logPsi_mean_curve_gauge_reset_min120.png",
    )
