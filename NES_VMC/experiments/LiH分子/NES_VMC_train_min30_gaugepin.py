"""
LiH / STO-3G / K=4 NES-VMC 最小训练脚本（30 轮）——规范方向脊约束版（gauge-direction ridge）
...
# ====================== 日志配置 ======================
logger = logging.getLogger("NES_VMC_K4_gaugepin")
...
log_path = "./日志/nes_vmc_0829_K4_LiH_STO-3G_min30_gaugepin.log"
...
lr = 0.1
qgt_diag_shift = 0.1
mu_ridge = 20.0            # 规范方向脊强度（把规范漂移模式的逆增益 1/0.1 -> 1/20）
...
# ====================== 训练循环 ======================
logger.info("\n" + "=" * 60)
logger.info("开始多链 NES-VMC 训练 | 规范方向脊约束版（gauge-direction ridge）")
logger.info("=" * 60)
logger.info(
