...
def compute_local_energies(machine, params,ha,sigma):
    """
...
@partial(jax.jit, static_argnames=("machine",))
def forces_expect_hermitian(machine, params,ha,sigma):
    """
    ...
    """
    # 1. 计算局部能量
    O_loc = compute_local_energies(machine, params,ha, sigma)
